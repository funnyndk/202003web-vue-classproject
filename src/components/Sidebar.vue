      ...
      <el-aside id="elaside" width="200px">
        <el-menu router>
          ...
          <el-menu-item index="/myproject">
            <template slot="title">
              <i class="el-icon-s-data"></i>我的项目
            </template>
          </el-menu-item>
          <el-menu-item index="/newproject">
            <template slot="title">
              <i class="el-icon-s-data"></i>申请立项
            </template>
          </el-menu-item>
          <el-menu-item index="/worktime">
            <template slot="title">
              <i class="el-icon-s-data"></i>工时信息
            </template>
          </el-menu-item>
          ...
          <el-menu-item index="/newprojectapprove">
            <template slot="title">
              <i class="el-icon-s-flag"></i>立项审批
            </template>
          </el-menu-item>
          <el-menu-item index="/worktimeapprove">
            <template slot="title">
              <i class="el-icon-s-flag"></i>工时信息审批
            </template>
          </el-menu-item>
         <!--
